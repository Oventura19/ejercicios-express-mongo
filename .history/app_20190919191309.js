...
app.get('/register', function(req, res) {
    res.send('<h1>Formulario de Registro</h1><br><form action="/register" method="post"><br>Nombre<br><label for="username"> <input type="text" id="name" name="name"><br><br>Email<br><label for="email"> <input type="text" id="email" email="email"><br><br>Contraseña<br><label for="password"> <input type="text" id="password" password="password"><br><button type="submit">Registrarse</button></form>');
});
