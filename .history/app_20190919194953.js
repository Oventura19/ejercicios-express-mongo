...
app.get('/register', function(req, res) {
    res.send('<br>Nombre<br><label for="username"> <input type="text" id="name" name="name"><br><br>Email<br><label for="email"> <input type="text" id="email" email="email"><br><br>Contraseña<br><label for="password"> <input type="password" id="password" password="password"><br><br><button type="submit">Registrarse</button></form>')
});
